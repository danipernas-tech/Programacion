...
/* =========================================================
    ...
    public static void main(String[] args) {
        ...
        double preciFinal = calcularPrecioFinal(PRECIO_BASE);

        imprimirInforme(media, aprobado, preciFinal);
    ...
    /* =====================================================
       ...
       ===================================================== */
    static double calcularMedia(double a, double b) {return (a + b) / 2.0;
    }
    ...
    static void imprimirInforme(double media, boolean aprobado, double precioFinal){
        ...
        if (familiaNumerosa){
            System.out.println("Familia numerosa: SIi");
        }else{
        ...
        String textoFracionado = (pagoFraccionado) ? "Si" : "No";

        System.out.println("Pago fracionado: " + textoFracionado);
