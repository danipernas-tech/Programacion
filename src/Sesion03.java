...
// Sesion_1.java
    ...
    //Separacion funcional, unidades funcionales, lo aisle en funcion
//1.Leer tarea
//2. Insertar tarea
//3. Mostrar menu
//4. Alta tarea, baja, etc
        ...
        static final int HIJOS_FAMILIA_NUM = 3;
        ...
        */
        ...
        static void leer_datos() {
            ...
            //Variable instrumental, solo dentro de la función
            System.out.println("Dime numero de hijos");
            int numeroHijos = sc.nextInt();

            if (numeroHijos < 0) {
                System.out.println("Numero de hijos no válido, tiene que ser positivo");
                numeroHijos = 0;
            }

            if (numeroHijos < HIJOS_FAMILIA_NUM) {
            ...
            String respuestaPago = sc.nextLine();

            if ( respuestaPago.equalsIgnoreCase("si") ||
                    respuestaPago.equalsIgnoreCase("sí")) {
                    pagoFraccionado = true;
            } else {
                pagoFraccionado = false;
            }

            //Convertir datos / Casting
            int numero = 10;
            double resultadoCasteo = numero;
        }
